                                  ...
                                  Container(
                                    ...
                                    ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return AspectRatio(
                                            aspectRatio: (itemWidth / itemHeight) / 2.005,
                                                // 1.9997,
                                  ...
                                  Container(
                                    ...
                                    child:  GridView.builder(
                                      ...
                                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                        ...
                                        childAspectRatio: (itemWidth / itemHeight), // Aspect ratio of each grid item
                                      ),
                                      // gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                      //   crossAxisCount: 2,
                                      //   mainAxisSpacing: 0,
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        String? previousSlotTime = timeIndex == 0 ? null : bookSlotController.slotList[timeIndex - 1];
                                        String? previousHalfHourSlotTime = previousSlotTime == null ? null : adjustTimeRange(previousSlotTime);

                                        // print("halfHourSlotTime :$index : $halfHourSlotTime");
                                        // print("timeIndex : $timeIndex");
                                        // print("slotTime : $slotTime");
                                        // print("previousSlotTime : previousSlotTime");
                                        print("previousHalfHourSlotTime : $previousHalfHourSlotTime");

                                        // print("slotTime :$index : $slotTime");/

                                        bool isCompletedOneHourSlot = false;
                                        bool isCompletedHalfHourSlot = false;
                                        bool isCompletedPreviousHalfHourSlot = false;
                                        ...
                                        if(previousHalfHourSlotTime != null) {
                                          timeHoursList2 = convertSlotToTimeHoursFrom(slotTime: previousHalfHourSlotTime!,year: year,month: month,day: day);
                                          List<String> timeHoursFrom2 = timeHoursList2[0];
                                          List<String> timeHoursTo2 = timeHoursList2[1];
                                          ...
                                          isCompletedPreviousHalfHourSlot = currentTime.isAfter(slotFromTime2);
                                        }
                                        ...
                                        print("isPractiseSlotHalfHour : $isPractiseSlotHalfHour $index");
                                        print("isPractiseSlotFirstHalf : $index $isPractiseSlotFirstHalf");
                                                  ...
                                                  child: Center(
                                                    child:  Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            padding: EdgeInsets.only(bottom: deviceHeight * 0.015,left: deviceWidth * 0.01),
                                                            child: Align(
                                                          ...
                                                          Align(
                                                              alignment: Alignment.topLeft,
                                                            child: Padding(
                                                              padding: EdgeInsets.only(top: deviceHeight * 0.01,left: deviceWidth * 0.015),
                                                              child: Text(
                                                                // time.toString(),
                                                                  "Kids Coaching Slot",
                                                                  textAlign: TextAlign.left,
